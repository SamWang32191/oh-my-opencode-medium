...
The `src/cli/` directory provides the command-line interface for installing and configuring **oh-my-opencode-medium**, an OpenCode plugin. It handles:
...
```
User runs: bunx oh-my-opencode-medium install
         │
         ▼
┌─────────────────────────────────────────┐
│ index.ts: parseArgs()                   │
...
└─────────────────┬───────────────────────┘
                  ...
                  ▼
┌─────────────────────────────────────────┐
│ Parse oh-my-opencode-medium.json          │
│ - Extract preset name                   │
...
| `oh-my-opencode-medium.json` | `~/.config/opencode/` | Plugin-specific config |

### Consumers

1. **End Users**: Via `bunx oh-my-opencode-medium install`
